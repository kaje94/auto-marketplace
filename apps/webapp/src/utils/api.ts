...
export const api = {
    ...
    //         next: { tags: [apiTags.getSubscriptionItem(id)], revalidate: revalidationTime.oneDay },
    //     }),
    ...
    //     fetchApi.get<State[]>(`/v1/Locations/countries/${countryCode?.toUpperCase()}/states`, {
    ...
    //     fetchApi.get<City[]>(`/v1/Locations/countries/${countryCode?.toUpperCase()}/states/${stateCode}/cities`, {
