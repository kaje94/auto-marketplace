...
import { DeleteSubscriptionItemModal } from "../Modals/DeleteSubscriptionItemModal";
import { ToggleSubscriptionActivationModal } from "../Modals/ToggleSubscriptionActivationModal";
                ...
                <ClickAwayListener onClickAway={() => setMenuVisible(false)}>
                    <div className={clsx("dropdown-end dropdown", menuVisible && "dropdown-open")}>
                        <ul className="dropdown-content menu rounded-box z-[1] mr-2 mt-6 w-52 rounded-tr-none bg-base-200 p-2 shadow-lg">
                            <MenuItem icon={<EditIcon height={18} />} link={`${window?.location?.pathname}/edit/${id}`} label="Edit" />
                            <MenuItem
